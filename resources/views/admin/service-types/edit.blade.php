<x-admin>
    <x-slot:title>تعديل نوع الخدمة</x-slot:title>
        ...
        <form action="{{ route('admin.service-types.update', $serviceType) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $serviceType->name) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="name_en" value="{{ old('name_en', $serviceType->name_en) }}"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:border-primary focus:outline-none">
