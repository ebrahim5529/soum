<x-admin>
    <x-slot:title>إدارة أنواع الخدمات</x-slot:title>
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-3xl font-bold text-gray-800">إدارة أنواع الخدمات</h2>
        <a href="{{ route('admin.service-types.create') }}" class="bg-primary text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                            ...
                            <td class="py-4 px-6">
                                <div class="flex items-center gap-3">
                                    <a href="{{ route('admin.service-types.edit', $type) }}" class="text-primary hover:text-blue-700">
                                        <i class="ri-edit-line text-xl"></i>
                                    </a>
                                    <form action="{{ route('admin.service-types.destroy', $type) }}" method="POST" onsubmit="return confirm('هل أنت متأكد من الحذف؟')">
                                        @csrf
                                        @method('DELETE')
