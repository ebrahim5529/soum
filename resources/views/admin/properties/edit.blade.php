        ...
        <form action="{{ route('admin.properties.update', $property) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea id="google_map_url" name="google_map_url" rows="3" placeholder="أدخل رابط Google Maps أو كود embed، مثال: https://www.google.com/maps/place/26.091855,43.980515"
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:border-primary focus:outline-none">{{ old('google_map_url', $property->google_map_url) }}</textarea>
                <div class="flex items-center gap-3 mt-2">
                    ...
                    <span id="preview-map-hint" class="text-gray-500 text-sm">أدخل الرابط أعلاه ثم انقر للمعاينة</span>
                </div>
