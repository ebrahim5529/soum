<x-admin>
    <x-slot:title>تعديل نوع العقار</x-slot:title>
        ...
        <form action="{{ route('admin.property-types.update', $propertyType) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $propertyType->name) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="name_en" value="{{ old('name_en', $propertyType->name_en) }}"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:border-primary focus:outline-none">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="icon" value="{{ old('icon', $propertyType->icon) }}"
