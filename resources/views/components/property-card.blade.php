...
<div class="property-card bg-white rounded-2xl overflow-hidden shadow-lg">
    <div class="relative">
        @php
            $mainImageUrl = $property instanceof \App\Models\Property 
                ? $property->main_image_url 
                : ($property->main_image ?? asset('images/placeholder.jpg'));
        @endphp
        <img src="{{ $mainImageUrl }}" alt="{{ $property->title }}" class="w-full h-64 object-cover object-top" loading="lazy">
